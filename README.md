...
To test the pipeline, the genomic files hosted in the Google Drive link must be extracted and kept in the current directory, where this particular README.md file is located. 
